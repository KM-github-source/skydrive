...
export default {
    ...
    reqWebUpload: (params) => requests({
        url: "/web/upload", method: 'POST', data: params,
        headers: {
            "Content-Type": "multipart/form-data",
        },
    }),
    reqWebDownload: (params) => requests({ url: "/web/download", method: 'POST', data: params, responseType: 'blob' }),
}